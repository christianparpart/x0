...
class X0_API XzeroPlugin {
 ...
 protected:
  ...
  x0::FlowVM::NativeCallback& setupFunction(
      const std::string& name, void (Class::*method)(x0::FlowVM::Params&),
      ArgTypes... argTypes);
  template <typename Class, typename... ArgTypes>
  x0::FlowVM::NativeCallback& sharedFunction(
      const std::string& name,
      void (Class::*method)(x0::HttpRequest* r, x0::FlowVM::Params&),
      ArgTypes... argTypes);
  template <typename Class, typename... ArgTypes>
  x0::FlowVM::NativeCallback& mainFunction(
      const std::string& name,
      void (Class::*method)(x0::HttpRequest* r, x0::FlowVM::Params&),
      ArgTypes... argTypes);
  template <typename Class, typename... ArgTypes>
  x0::FlowVM::NativeCallback& mainHandler(
      const std::string& name,
      bool (Class::*method)(x0::HttpRequest* r, x0::FlowVM::Params&),
      ArgTypes... argTypes);
  ...
  void onConnectionStateChanged(std::function<
      void(x0::HttpConnection*, x0::HttpConnection::State)>&& callback) {
    auto handle =
...
// {{{ flow integration
inline x0::FlowVM::NativeCallback& XzeroPlugin::addNative(
    x0::FlowVM::NativeCallback& cb) {
  natives_.push_back(&cb);
  return cb;
}

template <typename Class, typename... ArgTypes>
inline x0::FlowVM::NativeCallback& XzeroPlugin::setupFunction(
    const std::string& name, void (Class::*method)(x0::FlowVM::Params&),
    ArgTypes... argTypes) {
  return addNative(daemon_->setupFunction(
      name, [=](x0::FlowVM::Params& args) { (((Class*)this)->*method)(args); },
      argTypes...));
}

template <typename Class, typename... ArgTypes>
inline x0::FlowVM::NativeCallback& XzeroPlugin::sharedFunction(
    const std::string& name,
    void (Class::*method)(x0::HttpRequest*, x0::FlowVM::Params&),
    ArgTypes... argTypes) {
  return addNative(daemon_->sharedFunction(
      name, [=](x0::FlowVM::Params& args) {
              (((Class*)this)->*method)(
                  (x0::HttpRequest*)args.caller()->userdata(), args);
            },
      argTypes...));
}

template <typename Class, typename... ArgTypes>
inline x0::FlowVM::NativeCallback& XzeroPlugin::mainFunction(
    const std::string& name,
    void (Class::*method)(x0::HttpRequest*, x0::FlowVM::Params&),
    ArgTypes... argTypes) {
...
inline x0::FlowVM::NativeCallback& XzeroPlugin::mainHandler(
    const std::string& name,
    bool (Class::*method)(x0::HttpRequest*, x0::FlowVM::Params&),
    ArgTypes... argTypes) {
...
inline x0::HttpServer& XzeroPlugin::server() const { return *server_; }
...
#define X0_EXPORT_PLUGIN(pluginName) X0_EXPORT_PLUGIN_CLASS(pluginName##_plugin)

#define X0_EXPORT_PLUGIN_CLASS(className)               \
  extern "C" X0_EXPORT x0d::XzeroPlugin* x0plugin_init( \
