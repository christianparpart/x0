...
class ObjectCache {
 ...
 public:
  ...
  void setUpdateLockTimeout(const x0::TimeSpan& value) {
  ...
  void setDefaultShadowTTL(const x0::TimeSpan& value) {
...
class ObjectCache::ConcreteObject {
 public:
  ...
  const std::vector<std::pair<x0::BufferRef, std::string>>& varyingHeaders()
      const {
...
inline x0::JsonWriter& operator<<(x0::JsonWriter& json,
