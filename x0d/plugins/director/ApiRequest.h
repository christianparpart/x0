...
class ApiRequest : public x0::CustomData {
 private:
 ...
 public:
  ApiRequest(DirectorMap* directors, x0::HttpRequest* r,
             const x0::BufferRef& path);
  ~ApiRequest();

  static bool process(DirectorMap* directors, x0::HttpRequest* r,
                      const x0::BufferRef& path);
 ...
 private:
  ...
  // helper
  static std::vector<x0::BufferRef> tokenize(const x0::BufferRef& input,
