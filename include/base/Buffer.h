...
namespace std {
template <>
struct hash<base::BufferSlice> {
  typedef base::BufferSlice argument_type;
...
template <>
struct hash<base::BufferRef> {
  typedef base::BufferRef argument_type;
  typedef uint32_t result_type;
...
template <>
struct hash<base::Buffer> {
  typedef base::Buffer argument_type;
  typedef uint32_t result_type;
...
inline ostream& operator<<(ostream& os, const base::BufferRef& b) {
  os << b.str();
  return os;
}

inline ostream& operator<<(ostream& os, const base::Buffer& b) {
  os << b.str();
  return os;
}
}
