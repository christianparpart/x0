...
class Maybe {
 public:
  ...
  void expectSome() const { assert(isSome() && "value required."); }
...
class Maybe<T>::iterator {  // {{{
 ...
 public:
  ...
  bool operator==(const iterator& other) const {
    if (self_ == other.self_) return true;
...
template <typename T>
inline bool operator==(const Maybe<T>& a, const Maybe<T>& b) {
