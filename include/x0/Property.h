...
// C++ template based properties, as defined in:
...
class RValueReadProperty {
 ...
 public:
  template <class U>
  explicit RValueReadProperty(U v)
      : value_(v) {}
...
template <typename T, typename Object, T (Object::*real_get)() const>
class ReadProperty {
 private:
  Object* object_;
 ...
 public:
  ...
  void operator()(Object* obj) { object_ = obj; }

  T operator()() const { return (object_->*real_get)(); }

  T get() const { return (object_->*real_get)(); }

  operator T() const { return (object_->*real_get)(); }

  typedef T value_type;
};

template <typename T, typename Object, void (Object::*real_set)(T const&)>
class WriteProperty {
 private:
  Object* object_;
  T value_;
 ...
 public:
  ...
  WriteProperty(Object* obj) : object_(obj), value_() {}

  WriteProperty(Object* obj, T const& v) : object_(obj) { set(v); }
  ...
  void set(T const& value) { (object_->*real_set)(value); }
...
class Property {
 ...
 public:
  ...
  T operator()(const T& value) { return set_(value); }

  T get() const { return get_(); }

  T set(const T& value) { return set_(value); }
...
class IndexedProperty {
 ...
 public:
  ...
  bool has(Key const& key) const { return data_.find(key) != data_.end(); }

  std::size_t size() const { return data_.size(); }

  map_iterator begin() const { return data_.begin(); }

  map_iterator end() const { return data_.end(); }
