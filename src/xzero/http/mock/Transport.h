 ...
 * @see Executor
 */
class XZERO_BASE_HTTP_API Transport : public HttpTransport {
 public:
  /**
  ...
  const HttpResponseInfo& responseInfo() const XZERO_BASE_NOEXCEPT;

  /** Retrieves the response message body. */
  const Buffer& responseBody() const XZERO_BASE_NOEXCEPT;

  /** Tests whether this transport was aborted in last request handling. */
  bool isAborted() const XZERO_BASE_NOEXCEPT;

  /** Tests whether last message was completed. */
  bool isCompleted() const XZERO_BASE_NOEXCEPT;
...
// {{{ inlines
inline const HttpResponseInfo& Transport::responseInfo() const XZERO_BASE_NOEXCEPT {
  return responseInfo_;
}

inline const Buffer& Transport::responseBody() const XZERO_BASE_NOEXCEPT {
  return responseBody_;
}

inline bool Transport::isAborted() const XZERO_BASE_NOEXCEPT {
  return isAborted_;
}

inline bool Transport::isCompleted() const XZERO_BASE_NOEXCEPT {
  return isCompleted_;
}
// }}}
