 ...
 */
class XZERO_BASE_HTTP_API HttpInfo {
 public:
  ...
  size_t contentLength() const XZERO_BASE_NOEXCEPT { return contentLength_; }
  ...
  bool hasTrailers() const XZERO_BASE_NOEXCEPT { return !trailers_.empty(); }
