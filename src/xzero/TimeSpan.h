...
XZERO_BASE_API Buffer& operator<<(Buffer& buf, const TimeSpan& ts);
...
public:
  static XZERO_BASE_API xzero::TimeSpan max();
  static XZERO_BASE_API xzero::TimeSpan min();
};
}
