...
class strutils_test : public CPPUNIT_NS::TestFixture {
 ...
 private:
  void parse_url_full() {
    ...
    bool rv = x0::parseUrl("http://xzero.io:8080/path/to?query", protocol,
  ...
  void parse_url_0() {
    ...
    bool rv =
        x0::parseUrl("http://xzero.io", protocol, hostname, port, path, query);
  ...
  void parse_url_2() {
    ...
    bool rv = x0::parseUrl("https://xzero.io/", protocol, hostname, port, path,
                           query);
  ...
  void parse_url_3() {
    ...
    bool rv = x0::parseUrl("http://xzero.io/?query", protocol, hostname, port,
                           path, query);
  ...
  void parse_url_4() {
    ...
    bool rv =
        x0::parseUrl("http://::1:8080/", protocol, hostname, port, path, query);
