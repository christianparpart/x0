...
class strutils_test : public CPPUNIT_NS::TestFixture {
 public:
 ...
 private:
  void parse_url_full() {
    ...
    bool rv = base::parseUrl("http://xzero.io:8080/path/to?query", protocol,
  ...
  void parse_url_0() {
    ...
    bool rv =
        base::parseUrl("http://xzero.io", protocol, hostname, port, path, query);
  ...
  void parse_url_2() {
    ...
    bool rv = base::parseUrl("https://xzero.io/", protocol, hostname, port, path,
                           query);
  ...
  void parse_url_3() {
    ...
    bool rv = base::parseUrl("http://xzero.io/?query", protocol, hostname, port,
                           path, query);
  ...
  void parse_url_4() {
    ...
    bool rv =
        base::parseUrl("http://::1:8080/", protocol, hostname, port, path, query);
