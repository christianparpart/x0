...
template <>
X0_API FlowType LiteralExpr<RegExp>::getType() const {
  return FlowType::RegExp;
}

template <>
X0_API FlowType LiteralExpr<Cidr>::getType() const {
  return FlowType::Cidr;
}

template <>
X0_API FlowType LiteralExpr<bool>::getType() const {
  return FlowType::Boolean;
}

template <>
X0_API FlowType LiteralExpr<IPAddress>::getType() const {
  return FlowType::IPAddress;
}

template <>
X0_API FlowType LiteralExpr<long long>::getType() const {
  return FlowType::Number;
}

template <>
X0_API FlowType LiteralExpr<std::string>::getType() const {
