...
XZERO_BASE_API bool operator==(const DateTime& a, const DateTime& b);
XZERO_BASE_API bool operator!=(const DateTime& a, const DateTime& b);
XZERO_BASE_API bool operator<=(const DateTime& a, const DateTime& b);
XZERO_BASE_API bool operator>=(const DateTime& a, const DateTime& b);
XZERO_BASE_API bool operator<(const DateTime& a, const DateTime& b);
...
XZERO_BASE_API TimeSpan operator-(const DateTime& a, const DateTime& b);
XZERO_BASE_API DateTime operator+(const DateTime& a, const TimeSpan& b);
XZERO_BASE_API DateTime operator-(const DateTime& a, const TimeSpan& b);
...
XZERO_BASE_API std::string inspect(const DateTime& dt);
...
public:
  static XZERO_BASE_API xzero::DateTime max();
  static XZERO_BASE_API xzero::DateTime min();
};
}
